...
import com.techno.twilio.twilio.R
...
import kotlinx.android.synthetic.main.activity_video.changeAudioOutput
...
class VideoActivity : AppCompatActivity() {
    ...
    private val EXTRA_TWILIO_AUTH_TOKEN = "extra_twilio_auth_token"
...
//                .show()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val name = savedInstanceState?.getString("twilioAuthToken") ?: "Ali Connors"
        TWILIO_ACCESS_TOKEN = intent.getStringExtra("twilioAuthToken").toString()
        println("Set Content View:$TWILIO_ACCESS_TOKEN")

        if (savedInstanceState != null) {
            println("Set Content View:${savedInstanceState.getBundle("twilioAuthToken")}")
        }else{
            println("Set Cont View")
        }
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        Log.d(TAG, "my onCreateOptionsMenu")
        val inflater = menuInflater
        inflater.inflate(R.layout.activity_video, menu)
      audioDeviceMenuItem = menu.findItem(R.id.changeAudioOutput)
//
...
//        // so we need to updates the UI
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.changeAudioOutput -> showAudioDevices()
...
//        connectActionFab.setOnClickListener(connectActionClickListener())
        changeAudioOutput.show()
        changeAudioOutput.setOnClickListener(showAudioDevices())
    ...
    private fun showAudioDevices(): View.OnClickListener {
        return View.OnClickListener {
            print("showAudioDevices")
            println("showAudioDevices")
...
//    }
    ...
    private fun updateAudioDeviceIcon(selectedAudioDevice: AudioDevice?) {
        ...
        changeAudioOutput.setImageResource(audioDeviceMenuIcon);
    }
...
//                .setAction("Action", null).show()
    ...
    private fun createConnectDialog(
        ...
        val alertDialogBuilder = AlertDialog.Builder(context).apply {
            setIcon(R.drawable.ic_call_end_white_24px)
